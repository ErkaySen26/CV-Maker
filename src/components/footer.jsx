      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 px-4">
        ...
        <div>
          ...
          <p className="text-gray-400">
            CV Oluşturucu, kullanıcıların profesyonel ve etkileyici CV'ler hazırlamalarını kolaylaştırmak için tasarlanmış bir platformdur. Modern ve kullanıcı dostu tasarımlar sunar.
          </p>
        </div>
